                  ...
                  <Form class='flex w-3/4 h-[500px] bg-indigo-300 rounded-xl'>
                      ...
                      <section className='flex flex-col justify-between w-1/2'>
                          <div className='mt-6 flex flex-col'>
                              <input className='mb-14 text-2xl px-4 py-2 text-center bg-slate-100 outline-none rounded-xl' type='text' name="title" placeholder="title" onChange={e => formik.setFieldValue('title', e.target.value)} value={formik.values.title} />
                              <textarea className='px-4 py-2 bg-slate-100 outline-none rounded-xl resize-none h-[300px]' type='text' name="text" placeholder="text" onChange={e => formik.setFieldValue('text', e.target.value)} value={formik.values.text}/>
                          </div>
