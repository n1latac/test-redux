...
function Header(props) {
  ...
  const handleSideBar = (()=>setNavMenu(navMenu=>!navMenu))
  ...
  return (
    <header class="bg-bg bg-cover bg-opacity-1 sticky top-0 z-10">
      ...
      <div className='flex md:hidden py-4 px-5 justify-between'>
        ...
        {navMenu ?
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" color='white' cursor='pointer' viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8  hover:scale-110" onClick={handleSideBar}>
            <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
          </svg>

          :
          <svg cursor='pointer' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 transition-all duration-[2000ms] hover:scale-110" onClick={handleSideBar}>
        ...
        <div className='fixed top-16 right-0 active:top-16'>
            ...
            {/* <li className='p-2 text-center'><Link to={'/signUp'} class="header-link">Выйти</Link></li> */}
            </ul>
          </div>
        :
          <div className='fixed top-16 right-0 active:top-16'>
